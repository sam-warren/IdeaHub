/**
 * HotReloadSetup.js
 * This file manually watches for file changes in the app for use of 
 * hot reloading while running in a docker container.
 * 
 * Why?
 * 
 * Because Facebook is slow to fix their software and we have to do it for them.
 */
